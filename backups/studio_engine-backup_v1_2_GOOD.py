...
if config.PRINT_GENERATION_PARAMS:
    print("\n==============================")
    print("🎛️ AUDIO GENERATION CONFIG")
    print("==============================")
    print("MAX_AUDIO_LENGTH_MS:", config.MAX_AUDIO_LENGTH_MS)
...
# ============================================================
    ...
    def run_conversation(
        ...
        print("[ENGINE] Generation params:")
        print(" - max_audio_length_ms:", config.MAX_AUDIO_LENGTH_MS)
        print(" - temperature:", config.TEMPERATURE)
        print(" - topk:", config.TOP_K)
